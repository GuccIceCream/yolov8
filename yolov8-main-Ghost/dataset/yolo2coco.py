...
parser.add_argument('--image_path', default='D:\\alldata\\VisDrone2019\\VisDrone2019-DET-val\\images',type=str, help="path of images")
parser.add_argument('--label_path', default='D:\\alldata\\VisDrone2019\\VisDrone2019-DET-val\\labels',type=str, help="path of labels .txt")
