...
def parse_opt():
    ...
    parser.add_argument('--yaml', type=str, default='ultralytics/models/newmy/yolov8s-p2+Datten+MPDiou+Dysnake+dyhead.yaml', help='model.yaml path')
    # parser.add_argument('--yaml', type=str, default='ultralytics/models/v8/yolov8s.yaml',help='model.yaml path')
    ...
    parser.add_argument('--data', type=str,default='D:\\BaiduNetdiskDownload\\yolov8-main-Ghost\\ultralytics\\datasets\\VisDrone.yaml',help='data yaml path')
    ...
    parser.add_argument('--name', type=str, default='yolov8s-p2+Datten+MPDiou+EMSCP+dyhead', help='save to project/name')
